 ...
 * 실제 챗봇의 시스템 프롬프트에 주입되어 답변의 근거로 사용됩니다.
 */
...
const ADMISSION_KNOWLEDGE = {
  ...
  admission_2026: {
    ...
    qualifications: [
      "경상남도 소재 중학교 졸업(예정)자",
      "전 가족이 경상남도에 거주하는 타 시도 중학교 졸업자",
      "검정고시 합격자 (경남 거주자)"
    ],
    selection_method: "중학교 내신성적(석차백분율) 100% 반영"
  },
  dormitory: {
  ...
  scholarships: {
    annual_amount: "약 1억 원 규모 (향후 20년간 유지)",
    types: [
  ...
  special_programs: [
    "진해인재스쿨 (우수 강사진 초빙 수업)",
    "AI(인공지능) 및 4차 산업혁명 융합 교육",
    "학교장 삼품(三品)제 (지성, 인성, 용성)",
    "기숙형 특색 프로그램 및 멘토링"
  ]
};
